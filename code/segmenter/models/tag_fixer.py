...
def fix_error(pos, window, c_tag, tags, fix):
...
def fix_window(window, i, tags, fix=True):
    """
...
def fix_tags(tags: List[str]) -> List[str]:
    ...
    for i in range(len(tags) - 2):
        ...
        error_importance = fix_window(window, i, tags, fix=False)
